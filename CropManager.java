...
public class CropManager {
    ...
    private static Crop findExistingCrop(Crop selectedCrop) {
        for (Crop existingCrop : crops) {
            if (existingCrop.getName().equals(selectedCrop.getName()) && existingCrop.getQuantity() >= 0) {
                return existingCrop;
            }
        }
        return null;
        ...
        do {
            ...
            switch (choice) {
                ...
                default:
                    ...
                    type = null; // Reset type for the next iteration
            }
        } while (type == null);
    ...
    public static Crop selectCrop(Scanner scanner) {
        ...
        viewCrops(scanner);  // Display the list of crops
    ...
    public void saveToCSV(FileWriter writer) throws IOException {
        ...
        for (Crop crop : crops) {
            writer.write(crop.toCSV()); // Assuming Crop class has a toCSV method
        }
    }
}
