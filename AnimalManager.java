...
public class AnimalManager {
        ...
        do {
            ...
            switch (choice) {
                ...
                default:
                    ...
                    cropType = null; // Reset cropType for the next iteration
            }
        } while (cropType == null);
    ...
    private static Animal findExistingAnimal(Animal selectedAnimal) {
        for (Animal existingAnimal : animals) {
            if (existingAnimal.getName().equals(selectedAnimal.getName()) && existingAnimal.getQuantity() >= 0) {
    ...
    public void saveToCSV(FileWriter writer) throws IOException {
        ...
        for (Animal animal : animals) {
            writer.write(animal.toCSV()); // Assuming Animal class has a toCSV method
        }
    }
}
